...
if (typeof google != 'undefined') {
  var map_latlng = new google.maps.LatLng(50.6395998, 3.084393)
  var map_options = {
    zoom: 12,
    center: map_latlng,
  ...
  var markerIconDefault_image = new google.maps.MarkerImage("me/theme/images/marker.png",
  ...
  var markerIconDefault_shadow = new google.maps.MarkerImage("me/theme/images/marker_shadow.png",
...
$(function() {
  ...
  $('.blog').on('mouseenter', 'ul li .item', function() {
    $(this).find('.hover').stop(true).animate({
  ...
  function initGallery(filters, no_quicksand) {
    ...
    if (!no_quicksand) {
      $('.gallery ul').quicksand($('#portfolio-list-temp li'), {
        ...
        function() {
          if ($('.prettyPhoto').size() > 0) $(".prettyPhoto ul a").lightBox({
            maxWidth: $(document).width() - 40
          });
          masonryGallery();
        });
    } else {
...
$(document).ready(function() {
  ...
  $("#messageForm").submit(function() {
    ...
    $.post("me/contact.php", {
      ...
      function(data) {
        document.getElementById("messageState").innerHTML = "Votre message a bien été envoyé, merci ;)"
      }
    );
